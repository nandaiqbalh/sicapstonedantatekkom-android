...
interface ApiService {
	...
	@GET("api/v1/mahasiswa/profile")
	suspend fun getMahasiswaProfile(
		@Header("Authorization") apiToken: String,
		): ProfileRemoteResponse

	@POST("api/v1/mahasiswa/profile/editProcess")
	...
	@POST("api/v1/mahasiswa/profile/editPassword")
	...
	@Multipart
	@POST("api/v1/mahasiswa/profile/editPhotoProcess")
	...
	@POST("api/v1/mahasiswa/kelompok/terima-kelompok")
	suspend fun terimaKelompok(
		@Header("Authorization") apiToken: String,
	) : TerimaKelompokRemoteResponse

	@POST("api/v1/mahasiswa/kelompok/tolak-kelompok")
	suspend fun tolakKelompok(
		@Header("Authorization") apiToken: String,
	) : TolakKelompokRemoteResponse

	@POST("api/v1/mahasiswa/kelompok/add-kelompok-process")
	...
	@POST("api/v1/mahasiswa/kelompok/add-punya-kelompok-process")
	...
	@POST("api/v1/mahasiswa/kelompok/edit-kelompok-process")
	...
	@GET("api/v1/mahasiswa/data-dosen-pembimbing2")
	...
	@GET("api/v1/mahasiswa/sidang-proposal-kelompok")
